  ...
  return (
    <section id="expertise" className="py-24 px-6 md:px-8 bg-[#f7f7f7] border-b border-[#dedede]">
      <div className="max-w-[1220px] mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 mt-[55px] border-t border-[#dedede]">
          {expertiseItems.map((item, idx) => (
            <article
              key={idx}
              className="interactive-card min-h-[290px] p-[28px_24px] rounded-none border-r border-[#dedede] last:border-r-0 text-left cursor-pointer transition-all duration-300 relative hover:z-10 hover:bg-white hover:shadow-[0_20px_45px_rgba(15,23,42,0.1)]"
            >
